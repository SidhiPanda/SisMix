...
.config(function($stateProvider, $httpProvider, RestangularProvider) {
  ...
  .state('audioselect', {
    ...
    views: {
      'page': {
        templateUrl: 'partial/audioSelect.html',
        controller: "AudioSelect"
      }
    }
  })
  .state('audiosearch', {
    url: '/audioSearch/:media/:provider',
    views: {
      'page': {
        templateUrl: 'partial/audioSearch.html',
  ...
  .state('audioview', {
    ...
    views: {
      'page': {
        templateUrl: 'partial/audioView.html',
        controller: 'AudioView'
      }
    }
  })
  .state('favorites', {
